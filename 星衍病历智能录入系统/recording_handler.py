...
from threads import create_listen_thread, stop_listen_thread
...
class RecordingHandler:
    ...
    def start_recording(self):
        ...
        # 复用 threads.create_listen_thread 统一线程管理
        app.listen_thread = create_listen_thread(
            self.asr,
    ...
    def stop_recording(self):
        ...
        if app.listen_thread:
            stop_listen_thread(app.listen_thread, timeout_ms=2000)
