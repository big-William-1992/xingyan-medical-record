...
class RecordingHandler:
    ...
    def start_recording(self):
        ...
        # 保存录音前的编辑器内容
        self._stream_base_text = app.text_edit.toPlainText()
        ...
        app.listen_thread = app.ListenThreadClass(self.asr)
        ...
        mode = app.record_mode_combo.currentText()
        if "连续" in mode:
            app._auto_stop_timer = app.QTimer()
